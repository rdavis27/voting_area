    ...
    function(session,input, output) {
        ...
        createfiles <- function(races){
            if (input$createfiles){
                for (i in 1:length(races)){
                    ...
                    else if (races[i] == "TX_2022_Governor"){
                        createTX_2022_Governor()
                    }
        ...
        observeEvent(input$state2,{
            if (input$state2 == "AZ"){
                ...
                files <- c("TX_2022_Governor","TX_2022_Governor_OE","TX_2022_House_OE","TX_2020_President","TX_2020_President_OE","TX_2020_Senate","TX_2020_Senate_OE","TX_2020_House","TX_2020_House_OE","TX_2020_State_House","TX_2020_State_Senate","TX_2020_RR_Commission",
