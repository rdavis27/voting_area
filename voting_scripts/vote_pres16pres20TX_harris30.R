...
# 3. Download 'president.csv' from https://data.capitol.texas.gov/dataset/2016_general
#    by clicking Explore button to the right of "President Vice-President"
#    and selecting "Go to resource". Save file as 'president2016.csv'.
...
# Read precinct data for 2016 Presidential race in Texas
xx <- read_csv("president2016.csv")
race1 <- "TX_2016_President"
...
xx <- xx[,c(8,9,10,3:7)] # set columns to COUNTY, AREA, TOTAL, DEM, REP, other candidates
names(xx) <- c("COUNTY","AREA","TOTAL","Clinton","Trump16","Johnson","Stein","Writein")
xx$TOTAL <- rowSums(xx[,4:NCOL(xx)]) # set TOTAL to sum of all candidate votes
#partyxx <- c("COUNTY","AREA","TOTAL","DEM","REP","LIB","GRN","Writein")
